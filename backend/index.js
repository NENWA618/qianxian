...
app.post('/api/admin/params', csrfProtection, async (req, res) => {
  ...
  setParam(key, value, req.user.username);
  await logOperation({
    user_id: req.user.id,
...
app.post('/api/admin/params/batch', csrfProtection, async (req, res) => {
  ...
  setParamsBatch(updates, req.user.username);
  await logOperation({
    user_id: req.user.id,
    username: req.user.username,
    action: 'param_update_batch',
