...
// Session配置（修正：生产环境 sameSite: 'none', secure: true, domain: '.onrender.com'）
const sessionMiddleware = session({
  ...
  cookie: {
    ...
    sameSite: 'none', // 生产环境必须 none
    domain: '.onrender.com', // 新增，确保前后端都能访问同一个 session
...
// --- Socket.IO 聊天功能集成 ---
const server = http.createServer(app); // 只保留这一处
