 ...
 */
function recursiveAdaptiveLoad(node, depth, maxDepth, lastNorm, threshold, renderFn) {
  ...
  if (Array.isArray(node.children)) {
    node.children.forEach(child =>
      recursiveAdaptiveLoad(child, depth + 1, maxDepth, currentNorm, threshold, renderFn)
    );
  }
}
