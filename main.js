...
fetch('https://qianxian-backend.onrender.com/api/user', { credentials: 'include' })
  .then(res => res.json())
  .then(data => console.log('api/user 返回:', data))
  .catch(e => console.error('api/user 错误:', e));
...
function showPasswordStrength(password, container) {
  ...
  let color = '';
  switch (result.score) {
    case 0: text = '极弱'; color = 'red'; break;
    case 1: text = '弱'; color = 'orangered'; break;
    case 2: text = '中'; color = 'orange'; break;
    case 3: text = '强'; color = 'green'; break;
    case 4: text = '极强'; color = 'darkgreen'; break;
    default: text = ''; color = '';
  }
...
// PWA推送注册（如支持service worker和推送API）
